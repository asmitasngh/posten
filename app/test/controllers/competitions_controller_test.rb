...
class CompetitionsControllerTest < ActionController::TestCase
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post :create, competition: { category: @competition.category, levels: @competition.levels, no_of_teams: @competition.no_of_teams, rounds: @competition.rounds }
    end
  ...
  test "should update competition" do
    patch :update, id: @competition, competition: { category: @competition.category, levels: @competition.levels, no_of_teams: @competition.no_of_teams, rounds: @competition.rounds }
    assert_redirected_to competition_path(assigns(:competition))
  end
